...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-Debug.mk dist/Debug/GNU-Linux-x86/ovas

dist/Debug/GNU-Linux-x86/ovas: ${OBJECTFILES}
...
${OBJECTDIR}/GeoSequence.o: GeoSequence.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/GeoSequence.o GeoSequence.cpp
...
${OBJECTDIR}/Volume4D.o: Volume4D.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/Volume4D.o Volume4D.cpp

${OBJECTDIR}/StepToParamConverter.o: StepToParamConverter.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/StepToParamConverter.o StepToParamConverter.cpp
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	${RM} -r build/Debug
	${RM} dist/Debug/GNU-Linux-x86/ovas
